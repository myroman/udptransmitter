...
clean:
	rm prifinfo_plus prifinfo_plus.o get_ifi_info_plus.o server fileChunking.o server.o client client.o testClient testClient.o input.o testClient2.o testClient2 ifs.o CircularBufferNode.o CircularBufferNode
