...
all: get_ifi_info_plus.o prifinfo_plus.o server client testClient testClient2 testChunkFile CircularBufferNode ClientCircularBuffer
...
clean:
	rm prifinfo_plus prifinfo_plus.o get_ifi_info_plus.o server server.o client client.o testClient testClient.o input.o testClient2.o testClient2 testChunkFile testChunkFile.o ifs.o CircularBufferNode.o CircularBufferNode ClientCircularBuffer ClientCircularBuffer.o
