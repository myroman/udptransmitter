...
server: server.o input.o dtghdr.o fileChunking.o rtt.o
	${CC} ${FLAGS} -o server server.o  input.o dtghdr.o fileChunking.o rtt.o ${LIBS}
server.o: server.c
	${CC} ${FLAGS} -c server.c ${UNP}	
client: client.o input.o ifs.o dtghdr.o
	${CC} ${FLAGS} -o client client.o input.o ifs.o dtghdr.o -lm ${LIBS}
client.o: client.c 
